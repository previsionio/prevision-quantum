...
def get_gaussians_dataset(num_samples=50, holdout=20):
    ...
    samples = scaler.transform(np.random.multivariate_normal([5, 5], [[1, 0], [0, 1]], num_samples))
    samples2 = scaler.transform(np.random.multivariate_normal([-5, -5], [[1, 0], [0, 1]], num_samples))
    samples3 = scaler.transform(np.random.multivariate_normal([-5, 5], [[1, 0], [0, 1]], num_samples))
    samples4 = scaler.transform(np.random.multivariate_normal([5, -5], [[1, 0], [0, 1]], num_samples))
